...
function openEmergency() {
   document.getElementById("emergency").style.marginBottom = "220px";
}
...
function openRoute() {
    document.getElementById("route").style.marginBottom = "510px";
...
function openInterCity() {
    document.getElementById("interCity").style.marginBottom = "510px";
    document.getElementById("mySidenav").style.width = "500px"
}
